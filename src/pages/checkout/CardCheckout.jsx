...
export default function CardCheckout({dish, i, handleDeleteDish, handleDecrement, handlePlus, getPriceValue}) {


    return (
        <>
            <div id="product-checkout" className="products flex flex-row border border-dashed border-slate-50 bg-white bg-opacity-40 shadow-md rounded-xl overflow-hidden p-2 py-4">
                <section className="flex" id="dish-buttons-container">
                    <span id="trash" className="mr-2 self-center text-red-400 hover:text-orange-800 cursor-pointer"  onClick={()=>handleDeleteDish(dish.id)}>
